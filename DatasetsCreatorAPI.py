...
class ProgrammableWebScrapy:
    ...
    def __init__(self):
        #self.browser = webdriver.Firefox(executable_path="D:\msnet\geckodriver.exe")
        print("ayoub")
    def __del__(self):
        pass
        #self.browser.close()
    ...
    def get_page(self, url):
        ...
        page_source = self.site(url).decode("utf-8")
         #soup = BeautifulSoup(letter_source, 'html.parser')v
